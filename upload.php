...
<table width="100%" class="klein lg">
	<tr style="border-bottom:1px solid black;"><td><?= translate('Upload a new File','firma') ?></td><td align="right"><a href="javascript:top.main_window.newFile('left')">(X)</a></td></tr>
</table>
...
<br>
&nbsp;<input type="submit" value="<?= translate('save_','firma') ?>">
</form>
</html>
