...
// $Id$
    ...
    if ($_GET["holen"]) {
        ...
        $data["tid"] = $_GET["holen"]; 		$data["cause"] = $term["cause"];	$data["c_cause"] = $term["c_cause"];
        $data["repeat"] = $term["repeat"];	$data["ft"] = $term["ft"]; 		$data["location"] = $term["location"];
    ...
    if ($_POST["search"]<>"" || ($_POST["kategorie"]>0 && !$_POST["sichern"])) {
        ...
        if (!$rc) {
            ...
            $data["cause"] = $_POST["cause"];      $data["c_cause"]=$_POST["c_cause"];
            $data["ft"]=$_POST["ft"];            $data["repeat"]=$_POST["repeat"];
