...
if ($dateiname) {
    $ftmp=fopen("./dokumente/".$_SESSION["dbData"]["dbname"]."/".$_SESSION["login"]."/SerMail/".$dateiname,"rb");
    $filedata=fread($ftmp,filesize("./dokumente/".$_SESSION["dbData"]["dbname"]."/".$_SESSION["login"]."/SerMail/".$dateiname));
    fclose($ftmp);
