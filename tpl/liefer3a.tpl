...
<div style="position:absolute; left:0px; top:0px; width:500px; border:1px solid black" class="fett">
	{Name} &nbsp; {KDNR}<br />
	{Plz} {Ort}
</div>
...
<!-- END Liste -->
	<tr><td class="smal" colspan="6"><b>R</b>echnung, <b>A</b>nfrage, <b>L</b>ieferung/Auftrag</td></tr>
</table>
</div>
