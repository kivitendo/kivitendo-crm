<?php
    ...
    switch( $task ){
        case "newEvent":
            $sql="INSERT INTO termine (start, stop, cause, c_cause, allDay, prio) VALUES ( '$start'::TIMESTAMP, '$end'::TIMESTAMP,'$title','$desc', $allDay, $prio )";
        ...
        break;
        case "updateEvent":
            $sql="UPDATE termine SET cause = '$title', start = '$start'::TIMESTAMP, stop = '$end'::TIMESTAMP, c_cause = '$desc', allday = $allDay, uid = '$uid', prio = '$prio' WHERE id = $id";
            $rc=$_SESSION['db']->query($sql);   
        break;
        ...
        break;
        case "getEvents":
            $sql="SELECT cause AS title, start, stop AS end, c_cause AS desc, id, allday, uid, prio FROM termine";
