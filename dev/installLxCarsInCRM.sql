...
CREATE TABLE IF NOT EXISTS lxckba (
    ...
    field_14        TEXT, --Bezeichnung der nationalen Emissionsklasse
    ...
    f2              TEXT, --zulässige Gesamtmasse in kg im Zulassungsmitgliedstaat
    field_7_1       TEXT, --maximale Achslast Achse 1
    field_7_2       TEXT, --maximale Achslast Achse 2
    field_7_3       TEXT, --maximale Achslast Achse 3
    field_8_1       TEXT, --maximale Achslast Achse 1 im Zulassungsmitgliedstaat
    field_8_2       TEXT, --maximale Achslast Achse 2 im Zulassungsmitgliedstaat
    field_8_3       TEXT, --maximale Achslast Achse 3 im Zulassungsmitgliedstaat
    ...
    field_17        TEXT, --Merkmal zur Betriebserlaubnis
    field_21        TEXT, --Sonstige Vermerke,
    id              INT NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    CONSTRAINT lxckba_pkey PRIMARY KEY( id ),
    CONSTRAINT lxckba_unique UNIQUE( hsn, tsn, d2 )
);
COPY lxckba FROM '/var/www/kivitendo-crm/data/lxckba.csv' DELIMITER '|' CSV;
