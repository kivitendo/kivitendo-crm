...
*** Version 1.0.2 geschrieben Mai/2011 von Ronny Zimmermann ronny@lxcars.de *************************************
...
DROP FUNCTION IF EXISTS callin( text, text );
DROP FUNCTION IF EXISTS callout( text, text );
...
-- falls kein Name gefunden wird so wird die Telefonnummer zurück gegeben
DECLARE
    src ALIAS FOR $1;
    dst ALIAS FOR $2;
...
--SELECT callin( '0175-7880999', 'Autoprofis', '1225');
--SELECT suchenummer( '0175-7880998');
--SELECT * FROM Crmti;
