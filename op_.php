...
<input type="hidden" name="<?= ($_GET["Q"]=="C")?"customer":"vendor" ?>" value="<?= $_GET["fa"] ?>">
...
<input type="hidden" name="vc" value="<?= ($_GET["Q"]=="C")?"customer":"vendor" ?>">
<input type="hidden" name="nextsub" value="<?= ($_GET["op"]=="oe")?"orders":$_GET["op"]."_transactions" ?>">
<input type="hidden" name="type" value="<?= ($_GET["Q"]=="C")?"sales":"purchase" ?>_order">
