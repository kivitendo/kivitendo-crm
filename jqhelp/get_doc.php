    ...
    function OpenIOQ (src,id,type) {
	    ...
	    else if (src=="V"&&type=="inv") { uri="../oe.pl?action=edit&type=sales_quotation&vc=vendor&id=" + id }
	    else if (src=="C"&&type=="inv") { uri="../oe.pl?action=edit&type=sales_order&vc=customer&id=" + id }
	    else if (src=="V"&&type=="inv") { uri="../oe.pl?action=edit&type=sales_order&vc=vendor&id=" + id }
...
//ToDo: bgCol,  LimitAnzahl, klickbar!!
