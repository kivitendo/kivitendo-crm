...
<tr>
    <td>Bildupload</td>
    <td colspan="2"><input type="checkbox" value="1" name="nofiles" <?php echo (empty($nofiles)?'':"checked") ?>>nur bei neuen Artikeln</td>
    <td colspan="2"></td>
</tr>
<tr>
    <td>FTP-Host</td>
...
<tr>
    <td >Variantentext</td>
    <td colspan="3"><input type="radio" name="variantnr"  value="1" <?php echo ($variantnr<>2)?"checked":'' ?>>Artikelbezeichnung anhängen
    <input type="radio" name="variantnr"  value="2" <?php echo ($variantnr==2)?"checked":'' ?>>Langebeschreibung voranstellen</td>
</tr>
<tr>
